package com.example.customersrecord_rivera;
...
import org.json.JSONObject;
    ...
    private static String urlHost = "http://192.168.254.115/ancuin/InsertTrans.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnQuery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fullname = edtitemcode.getText().toString(); new uploadDataToURL().execute();
            }
        });
